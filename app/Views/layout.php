...
<head>
    ...
    <title><?= $title ?></title>
    <link rel="icon" href="/template/img/Logo.png" type="image/x-icon">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2 mb-2" href="/">
                <div class="sidebar-brand-icon rotate-n-0">
                    <!-- <i class="fas fa-laugh-wink"></i> -->
                     <img src="/template/img/Logo.png" style="width: 60px; height: 60px;">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/santriSD">SD</a>
                        <a class="collapse-item" href="/santriSMP">SMP</a>
                        <a class="collapse-item" href="/santriSMA">SMA</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseKesehatan" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/kesehatan">Input Pasien</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseKesantrian" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/Kesantrian/konseling">Bimbingan & Konseling</a>
                    </div>
                </div>
            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href='/login'>Keluar</a>
                </div>
            </div>
        </div>
    </div>
